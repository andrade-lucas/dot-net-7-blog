...
public class AccountController : ControllerBase
{
    ...
    )
    {
        ...
        {
            return StatusCode(500, new ResultViewModel<string>("Ocorreu um erro ao registrar o usuário"));
        }
        catch
        {
    ...
    )
    {
        ...
        user.Image = $"https://localhost:5199/images/{fileName}";
        try
        {
        ...
        return Ok(new ResultViewModel<string>(user.Image));
    }
}
